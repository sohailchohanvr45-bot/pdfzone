...
import { FileText, Upload, File, Trash2, Download, Settings, ArrowUp, ArrowDown, CheckCircle, Loader2, ChevronDown, ImageIcon } from 'lucide-react'
...
export default function PngToPdf() {
  ...
  const handleConvert = async () => {
    ...
    try {
      ...
      alert('Failed to convert PNG files. Please make sure all files are valid PNG images.')
      setStep('preview')
      setIsProcessing(false)
    }
  }
  ...
  return (
    <div className="min-h-screen bg-white text-gray-900">
      <ToolSchema
        name="PNG to PDF - Free Online PNG to PDF Converter"
        description="Convert PNG images to PDF format online for free. Combine multiple PNG files into one PDF document with custom page settings. Easy to use, secure, and fast. Works directly in your browser."
        url="https://pdfzone.cloud/png-to-pdf"
        applicationCategory="UtilitiesApplication"
        operatingSystem="Web Browser"
      />
      
      <Header activePage="/png-to-pdf" />

      {/* Main Content */}
      <main className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        {/* Title and Description */}
        <div className="text-center mb-12">
          <div className="inline-flex items-center justify-center mb-6 bg-purple-100 p-3 rounded-full">
            <ImageIcon className="h-8 w-8 text-purple-600" />
          </div>
          <h1 className="text-4xl font-bold text-gray-800 mb-4">PNG to PDF Converter</h1>
          <p className="text-lg text-gray-600 max-w-3xl mx-auto">
            Convert PNG images to PDF format instantly. Upload your PNG files, customize page settings, and create professional PDF documents. Fast, secure, and completely free.
          </p>
        </div>
              ...
              >
                ...
                <div className="relative flex flex-col items-center gap-5">
                  ...
                  <div className="relative">
                    ...
                    <div className="relative bg-gradient-to-br from-green-500 to-green-600 p-4 rounded-2xl shadow-lg group-hover:shadow-xl group-hover:scale-110 transition-all">
                  ...
                  {/* Button */}
                  <button className="bg-gradient-to-r from-green-600 to-green-700 text-white px-7 py-3 rounded-xl font-bold hover:shadow-xl hover:scale-105 transition-all">
                    Choose PNG Files
                  </button>
            ...
            <div className="space-y-6">
              ...
              <div className="bg-white rounded-xl p-6 border border-gray-200">
                <div className="flex items-center justify-between mb-4">
                  ...
                  <button
                    onClick={() => fileInputRef.current?.click()}
                    className="flex items-center gap-2 px-4 py-2 bg-gradient-to-r from-green-600 to-green-700 text-white rounded-lg font-semibold text-sm hover:shadow-lg hover:scale-105 transition-all"
                  >
                ...
                <div className="space-y-3 max-h-96 overflow-y-auto">
                  {files.map((file, index) => (
                    <div
                      key={index}
                      className="flex items-center gap-3 bg-gray-50 p-4 rounded-lg border border-gray-200 hover:border-green-300 transition-colors"
                    >
              ...
              <div className="text-center space-y-6">
                ...
                <div className="max-w-md mx-auto">
                  <div className="bg-gray-200 rounded-full h-3 overflow-hidden">
                    <div
                      className="bg-gradient-to-r from-green-600 to-green-700 h-full transition-all duration-300 ease-out"
            ...
            <div>
              <div className="text-center space-y-6">
                ...
                <button
                  ...
                  className="bg-gradient-to-r from-green-600 to-green-700 text-white px-8 py-4 rounded-xl font-bold hover:shadow-xl hover:scale-105 transition-all flex items-center justify-center gap-2 max-w-md mx-auto w-full"
                >
                ...
                <div className="flex flex-col sm:flex-row gap-3 max-w-md mx-auto">
                  ...
                  <Link
                    href="/"
                    className="flex-1 px-6 py-3 border border-green-600 text-green-600 rounded-lg font-semibold hover:bg-green-50 transition-colors text-center"
                  >
                    Try Other Tools
                  </Link>
                </div>
        ...
        <section className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
          <div className="grid md:grid-cols-3 gap-6">
            <div className="bg-white rounded-xl p-6 shadow-sm border border-gray-200">
              ...
              <p className="text-gray-600 text-sm">
                Convert multiple PNG images into a single PDF document
              </p>
            </div>
            <div className="bg-white rounded-xl p-6 shadow-sm border border-gray-200">
              <div className="w-12 h-12 bg-green-100 rounded-lg flex items-center justify-center mb-4">
        ...
        <div className="max-w-4xl mx-auto">
          <div className="bg-gradient-to-br from-green-50 to-white rounded-2xl p-8 border border-green-200">
            <p className="text-gray-700 text-base leading-relaxed mb-4">
              Got some PNG images you need as a PDF? We've got you covered! Just drop your files in, arrange them how you want, and we'll turn them into a clean PDF. Want to tweak things? Pick your page size (A4, Letter, or let the image decide), choose portrait or landscape, adjust the quality, and set your margins. It's all up to you!
            </p>
            <p className="text-gray-700 text-base leading-relaxed">
              Here's the cool part – everything happens right in your browser. Your images never get uploaded anywhere, so your stuff stays 100% private. No servers, no cloud storage, just your computer doing the work. And yep, it's totally free. No sign-ups, no limits, no watermarks. Just quick and easy PNG to PDF conversion whenever you need it!
            </p>
          </div>
        </div>
            ...
            <ol className="space-y-6">
              <li className="flex gap-4">
                ...
                <div className="flex-1 pt-1">
                  <h3 className="text-lg font-bold text-gray-800 mb-1">Upload Your PNG Files</h3>
                  <p className="text-gray-600">
                    Click "Choose PNG Files" or drag and drop your PNG images into the upload area. You can add multiple images at once.
                  </p>
                </div>
              </li>
          ...
          <div className="space-y-4">
            ...
            <div className="bg-white rounded-xl border border-gray-200 overflow-hidden hover:shadow-md transition-shadow">
              ...
              <div id="faq-0" style={{ display: 'none' }} className="px-6 pb-6 pt-2">
                <p className="text-gray-600 leading-relaxed">
                  Yes! You can upload multiple PNG images at once. All images will be combined into a single PDF document in the order you uploaded them. There's no limit to the number of images you can add.
                </p>
              </div>
            </div>
            ...
            <div className="bg-white rounded-xl border border-gray-200 overflow-hidden hover:shadow-md transition-shadow">
              ...
              <div id="faq-1" style={{ display: 'none' }} className="px-6 pb-6 pt-2">
                <p className="text-gray-600 leading-relaxed">
                  Absolutely! Our PNG to PDF converter is 100% free with no hidden charges, subscriptions, or file limits. You can convert as many images as you need without any restrictions.
                </p>
              </div>
            </div>
